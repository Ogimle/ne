        ...
        namespace particle
        {
            ...
            class IParticleDrawer : public irr::IReferenceCounted
            {
                public:
                    ...
                    virtual IParticleEmitter* addStandardEmitter(
                        ...
                        const irr::u32& minPpS = 50,
                        const irr::u32& maxPpS = 100,
                        const irr::u32& maxEmitt = 100,
                        const irr::u32& minlifetime = 100,
                        const irr::u32& maxlifetime = 1000,
                        ...
                        const irr::video::SColor& maxColor = irr::video::SColor(255,255,255,255)) = 0;

                    virtual irr::video::SMaterial& getMaterial(void) = 0;

                    virtual void addUVCoords(const SParticleUV& coord) = 0;

                    virtual void doParticles(const irr::scene::ICameraSceneNode* camera, const irr::core::matrix4& transform, irr::u32 timeMs, irr::f32 diff) = 0;
                    ...
                    virtual void drawParticles(irr::core::matrix4& transform, irr::video::IVideoDriver* driver, bool useOneMaterial) = 0;
