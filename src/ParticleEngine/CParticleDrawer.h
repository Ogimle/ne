...
#include "Irrlicht/Particle.h"
#include "Irrlicht/IParticleDrawer.h"
#include <irrList.h>
#include <SMaterial.h>
...
public:
    ...
    virtual void drawParticles(irr::core::matrix4& transform, irr::video::IVideoDriver* driver, bool useOneMaterial);
